...
Run checkhealth to check for needed dependecies.
### Keybinds:
#### LSP
...
* `gq`: Format current buffer
#### Autocomplete
* `Tab`: Starts autocomplete/move to next autocomplete item
* `Shift+Tab`: Move to previous autocomplete item
* `Enter`: Confirm autocompletion
* `Ctrl-e`: Cancel completion
* `Ctrl-d`: Scroll down in the items documentation
* `Ctrl-u`: Scroll up in the item's documentation
#### Others
* Can be found at the bottom of `init.lua`
